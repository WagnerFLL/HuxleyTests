...
class Test952 {
    ...
    @Test
    void runTest1() {
        Assertions.assertEquals(1, q952.q952.run("vOuPassArEmp1".toCharArray()));
    }
    ...
    void runTest2() {
        String frase = "vOuPassArEmp1vOuPassArEmp1vOuPassArEmp1v" +
                ...
                "vOuPassArEmp1";
        Assertions.assertEquals(13, q952.q952.run(frase.toCharArray()));
    }

    @Test
    void runTest3() {
        String frase = "Vou Perder P1";
        Assertions.assertEquals(0, q952.q952.run(frase.toCharArray()));
    }
    ...
    void runTest4() {
        String frase = "VvVvvvvvVVVVVVVVVVVvvvvvvccvvVVVv" +
                        ...
                        "Mmmm" +
                        "11";
        Assertions.assertEquals(2, q952.q952.run(frase.toCharArray()));
    }
